        ...
        <div class="my-16 flex flex-col gap-4">
            <form action="">
                ...
                <div class="col-span-full">
                    <label for="comment" class="block text-xl font-semibold leading-6 text-gray-900">Comment</label>
                    <div class="mt-2">
                      <textarea id="comment" name="comment" rows="3" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-lime-400 sm:text-sm sm:leading-6 " placeholder="Write a comment..."></textarea>
                    </div>
                </div>
                <button type="submit"
