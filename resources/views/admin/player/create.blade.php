                    ...
                    <div class="pb-12 mx-5">
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-2 sm:col-start-1">
                                ...
                                <div class="mt-2">
                                  <input type="text" name="height" id="height" autocomplete="address-level2" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" value="{{ old('height') }}">
                                </div>
                                @error('height')
                                    <div class="text-sm font-thin text-red-500">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="sm:col-span-2">
                                <label for="position" class="text-base font-semibold text-primary-darkblue">Country</label>
                                <div>
                        ...
                        <div class="mt-10">
                            <button class="bg-primary-darkblue text-primarybw-white px-4 py-2 text-base font-semibold rounded-md">Assign Player</button>
                        </div>
                    </div>
